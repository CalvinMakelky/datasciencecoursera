...
#img_test('C:\Users\CJ\Desktop\Python','LEAF.JPG')
...
image = Image.open('blurry_img (10).JPG')
output_image=_sharpen(image,sharpness=10)
output_image.save('sharpBlurred2.JPG')
